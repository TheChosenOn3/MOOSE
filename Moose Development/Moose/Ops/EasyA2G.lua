...
function EASYA2G:_TryAssignMission(ReadyFlightGroups, Auftrag, Group, WingSize)
  return self:_TryAssignTasking(ReadyFlightGroups, Auftrag, Group, WingSize, true)
end
...
function EASYA2G:_AssignMission(Cluster)
  ...
  local ReadyFlightGroups = self:_CollectReadyFlightGroups(true)
...
function EASYA2G:onafterStatus(From,Event,To)
  ...
  self.ReadyFlightGroups = self:_CollectReadyFlightGroups(true)
